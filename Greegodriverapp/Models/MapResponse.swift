...
//
//   let mapResponse = try? JSONDecoder().decode(MapResponse.self, from: jsonData)
...
public struct GeocodedWaypoint: Codable {
...
public struct Route: Codable {
    ...
    public let warnings, waypointOrder: [JSONAny]
...
public struct Bounds: Codable {
    public let northeast, southwest: Northeast
}
...
public struct Leg: Codable {
    ...
    public let endLocation: Northeast
    public let startAddress: String
    public let startLocation: Northeast
    public let steps: [Step]
    public let trafficSpeedEntry, viaWaypoint: [JSONAny]
